...
#include "franka_pybridge_interfaces/msg/detail/joint_data_array__rosidl_typesupport_fastrtps_c.h"
...
using _JointDataArray__ros_msg_type = franka_pybridge_interfaces__msg__JointDataArray;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _JointDataArray__ros_msg_type * ros_message = static_cast<const _JointDataArray__ros_msg_type *>(untyped_ros_message);
  // Field name: data
  {
  ...
  void * untyped_ros_message)
{
  ...
  _JointDataArray__ros_msg_type * ros_message = static_cast<_JointDataArray__ros_msg_type *>(untyped_ros_message);
  // Field name: data
  {
    uint32_t cdrSize;
    cdr >> cdrSize;
...
static uint32_t _JointDataArray__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_franka_pybridge_interfaces__msg__JointDataArray(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = franka_pybridge_interfaces__msg__JointDataArray;
    is_plain =
      (
...
static size_t _JointDataArray__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_franka_pybridge_interfaces__msg__JointDataArray(
...
static message_type_support_callbacks_t __callbacks_JointDataArray = {
...
static rosidl_message_type_support_t _JointDataArray__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_JointDataArray,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, franka_pybridge_interfaces, msg, JointDataArray)() {
  return &_JointDataArray__type_support;
}
