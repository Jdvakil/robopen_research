...
#include "franka_pybridge_interfaces/srv/detail/set_load__rosidl_typesupport_fastrtps_c.h"
...
using _SetLoad_Request__ros_msg_type = franka_pybridge_interfaces__srv__SetLoad_Request;
...
size_t get_serialized_size_franka_pybridge_interfaces__srv__SetLoad_Request(
  const void * untyped_ros_message,
...
static uint32_t _SetLoad_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_franka_pybridge_interfaces__srv__SetLoad_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_franka_pybridge_interfaces
size_t max_serialized_size_franka_pybridge_interfaces__srv__SetLoad_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = franka_pybridge_interfaces__srv__SetLoad_Request;
    is_plain =
      (
...
static size_t _SetLoad_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_franka_pybridge_interfaces__srv__SetLoad_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, franka_pybridge_interfaces, srv, SetLoad_Request)() {
...
using _SetLoad_Response__ros_msg_type = franka_pybridge_interfaces__srv__SetLoad_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_franka_pybridge_interfaces
size_t get_serialized_size_franka_pybridge_interfaces__srv__SetLoad_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _SetLoad_Response__ros_msg_type * ros_message = static_cast<const _SetLoad_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_franka_pybridge_interfaces__srv__SetLoad_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_franka_pybridge_interfaces
size_t max_serialized_size_franka_pybridge_interfaces__srv__SetLoad_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = franka_pybridge_interfaces__srv__SetLoad_Response;
    is_plain =
      (
...
static size_t _SetLoad_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_franka_pybridge_interfaces__srv__SetLoad_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, franka_pybridge_interfaces, srv, SetLoad_Response)() {
...
// already included above
// #include "franka_pybridge_interfaces/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "franka_pybridge_interfaces/srv/set_load.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, franka_pybridge_interfaces, srv, SetLoad)() {
