...
static const _SetLoad_Request_type_support_symbol_names_t _SetLoad_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, franka_pybridge_interfaces, srv, SetLoad_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, franka_pybridge_interfaces, srv, SetLoad_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, franka_pybridge_interfaces, srv, SetLoad_Request)() {
  return &::franka_pybridge_interfaces::srv::rosidl_typesupport_c::SetLoad_Request_message_type_support_handle;
}
...
static const _SetLoad_Response_type_support_symbol_names_t _SetLoad_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, franka_pybridge_interfaces, srv, SetLoad_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, franka_pybridge_interfaces, srv, SetLoad_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, franka_pybridge_interfaces, srv, SetLoad_Response)() {
  return &::franka_pybridge_interfaces::srv::rosidl_typesupport_c::SetLoad_Response_message_type_support_handle;
}
...
static const _SetLoad_type_support_symbol_names_t _SetLoad_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, franka_pybridge_interfaces, srv, SetLoad)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, franka_pybridge_interfaces, srv, SetLoad)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, franka_pybridge_interfaces, srv, SetLoad)() {
  return &::franka_pybridge_interfaces::srv::rosidl_typesupport_c::SetLoad_service_type_support_handle;
}
