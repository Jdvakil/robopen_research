...
class Metaclass_SetLoad(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'franka_pybridge_interfaces.srv.SetLoad')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from franka_pybridge_interfaces.srv import _set_load
...
class SetLoad(metaclass=Metaclass_SetLoad):
    from franka_pybridge_interfaces.srv._set_load import SetLoad_Request as Request
    from franka_pybridge_interfaces.srv._set_load import SetLoad_Response as Response
