...
#include "franka_pybridge_interfaces/srv/detail/set_load__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const franka_pybridge_interfaces::srv::SetLoad_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  franka_pybridge_interfaces::srv::SetLoad_Request & ros_message)
{
  // Member: mass
  cdr >> ros_message.mass;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = franka_pybridge_interfaces::srv::SetLoad_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const franka_pybridge_interfaces::srv::SetLoad_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<franka_pybridge_interfaces::srv::SetLoad_Request *>(
    untyped_ros_message);
...
{
  return &franka_pybridge_interfaces::srv::typesupport_fastrtps_cpp::_SetLoad_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, franka_pybridge_interfaces, srv, SetLoad_Request)() {
  return &franka_pybridge_interfaces::srv::typesupport_fastrtps_cpp::_SetLoad_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_franka_pybridge_interfaces
cdr_serialize(
  const franka_pybridge_interfaces::srv::SetLoad_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: success
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  franka_pybridge_interfaces::srv::SetLoad_Response & ros_message)
{
  // Member: success
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = franka_pybridge_interfaces::srv::SetLoad_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const franka_pybridge_interfaces::srv::SetLoad_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<franka_pybridge_interfaces::srv::SetLoad_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &franka_pybridge_interfaces::srv::typesupport_fastrtps_cpp::_SetLoad_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, franka_pybridge_interfaces, srv, SetLoad_Response)() {
  return &franka_pybridge_interfaces::srv::typesupport_fastrtps_cpp::_SetLoad_Response__handle;
}
...
{
  return &franka_pybridge_interfaces::srv::typesupport_fastrtps_cpp::_SetLoad__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, franka_pybridge_interfaces, srv, SetLoad)() {
  return &franka_pybridge_interfaces::srv::typesupport_fastrtps_cpp::_SetLoad__handle;
}
