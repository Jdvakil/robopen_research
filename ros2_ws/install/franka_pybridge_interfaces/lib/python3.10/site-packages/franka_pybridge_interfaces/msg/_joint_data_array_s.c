...
bool franka_pybridge_interfaces__msg__joint_data_array__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("franka_pybridge_interfaces.msg._joint_data_array.JointDataArray", full_classname_dest, 63) == 0);
  }
  franka_pybridge_interfaces__msg__JointDataArray * ros_message = _ros_message;
  {  // data
...
{
  /* NOTE(esteve): Call constructor of JointDataArray */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("franka_pybridge_interfaces.msg._joint_data_array");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "JointDataArray");
