...
#ifndef FRANKA_PYBRIDGE_INTERFACES__SRV__DETAIL__SET_LOAD__FUNCTIONS_H_
#define FRANKA_PYBRIDGE_INTERFACES__SRV__DETAIL__SET_LOAD__FUNCTIONS_H_
 ...
 * calls
 * franka_pybridge_interfaces__srv__SetLoad_Request__init().
...
/**
 * It calls
 * franka_pybridge_interfaces__srv__SetLoad_Request__fini()
 ...
 * franka_pybridge_interfaces__srv__SetLoad_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * franka_pybridge_interfaces__srv__SetLoad_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * franka_pybridge_interfaces__srv__SetLoad_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_franka_pybridge_interfaces
...
/**
 * It calls
 * franka_pybridge_interfaces__srv__SetLoad_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_franka_pybridge_interfaces
...
/**
 * It allocates the memory for the array and calls
 * franka_pybridge_interfaces__srv__SetLoad_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_franka_pybridge_interfaces
...
/**
 * It calls
 * franka_pybridge_interfaces__srv__SetLoad_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // FRANKA_PYBRIDGE_INTERFACES__SRV__DETAIL__SET_LOAD__FUNCTIONS_H_
